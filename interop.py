...
class InteropRunner:
    ...
    def _copy_logs(self, container: str, dir: tempfile.TemporaryDirectory):
        ...
        print("inisde copy logs")
        print('docker cp ' +  container  + ':/logs/. ' + dir.name)
        print("outputting return code")
        print(r)
        if r.returncode != 0:
            logging.info(
    ...
    def _run_test(
        ...
        if not expired:
            ...
            if self._is_unsupported(lines):
                ...
                try:
                    print("clinet existed with code 0")
        ...
        if status == TestResult.FAILED or status == TestResult.SUCCEEDED:
            ...
            print(server_log_dir.name)
            print(log_dir + "/server")
            ...
            if self._save_files and status == TestResult.FAILED:
                ...
                try:
                    ...
                    print("caught in exception while copying")
