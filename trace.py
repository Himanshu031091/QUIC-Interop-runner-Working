...
class TraceAnalyzer:
    ...
    def _get_packets(self, f: str) -> List:
        ...
        try:
            ...
            print("caught in exception in get packets")
            logging.debug(e)
        ...
        for packet in self._get_packets(
            ...
            for layer in packet.layers:
                if (
                    ...
                    packets.append(layer)
        print("exiting from get long header")
        return packets
